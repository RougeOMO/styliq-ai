...
def analyze_face(uploaded_file, stylist_persona):
    ...
    with mp_face_mesh.FaceMesh(static_image_mode=True, max_num_faces=1) as face_mesh:
        ...
        # 🟢 Prompt Terminology Preserved
        prompt = f"""
        Role: You are {s_name}, a top-tier {s_role} at STYLIQ.
        Philosophy: {s_style}.
        Tone: {s_tone}. 
        
        INPUT DATA:
        - Measured Face L/W Ratio: {ratio:.2f}
        
        INTERNAL THINKING (HIDDEN):
        1. **Gender Check**: Visual ID (Feminine vs Masculine).
        2. **Shape Check**: Visual judgment.
        3. **Undertone Check**: Look at the skin. Cool/Warm/Neutral?
        
        OUTPUT RULES (STRICT):
        1. **FORMAT**: Use Markdown headers (###).
        2. **NAMING**: Generate a SPECIFIC name (e.g., "Textured French Bob"). DO NOT write "[Hairstyle Name]".
        
        TASK:
        ### 1. 4-Dimensional Dashboard
        - **Face Shape**: [e.g., Oval, Heart, Square]
        - **Hair Type**: [e.g., Straight, Wavy, Coily]
        - **Color Analysis**: [Skin Undertone + Contrast Level]
        - **Vibe**: [3 Adjectives]

        ### 2. Analysis
        [Paragraph explaining their features warmly.]

        ### 3. Recommendation
        **[INSERT_SPECIFIC_HAIRSTYLE_NAME_HERE]**
        [Vivid description of the style and WHY it works.]

        ### 4. Technical Ticket
        - **Cut**: [Details]
        - **Coloring**: [Hair dye recommendation. Say "Keep Natural" if appropriate, or suggest a specific tone.]
        - **Styling**: [Details]
        
        🔴 **MANDATORY FOOTER**: 
        The very last line of your response MUST be exactly: 
        "HAIRSTYLE_NAME: [The exact name you chose above]"
        """
...
with st.container():
    ...
    with col1:
        ...
        # 🟢 RESTORED: Full text content for user guidance
